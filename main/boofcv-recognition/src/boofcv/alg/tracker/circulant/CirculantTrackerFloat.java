 ...
 * @author Peter Abeles
 */
public class CirculantTrackerFloat<T extends ImageGray<T>> {
	 ...
	 */
	public CirculantTrackerFloat(float output_sigma_factor, float sigma, float lambda, float interp_factor,
								 float padding ,
								 int workRegionSize ,
								 float maxPixelValue,
