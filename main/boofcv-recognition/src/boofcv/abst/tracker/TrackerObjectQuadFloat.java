...
public interface TrackerObjectQuadFloat<T extends ImageBase<T>> {
	...
	/**
	 * Updates the tracks location using the latest video frame.  {@link #initialize(ImageBase, Quadrilateral_F64)}
